...
export default async function HeaderHeroComponent() {
    ...
    return (
        <Container className="mt-10 flex flex-col pb-24 md:flex-row md:items-center md:justify-between">
            <div>
                <h3 className="text-xl font-light ">Dylan Clemann</h3>
                <h1 className="mb-5 text-4xl font-extrabold leading-9 tracking-wider lg:text-5xl">
                    Software Engineer
                </h1>
